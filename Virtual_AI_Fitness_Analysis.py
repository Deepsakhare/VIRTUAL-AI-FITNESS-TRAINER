...
win.title("Virtual AI Fitness Analysis")
...
def proceed():
    """
    Displays a window with three buttons: Live Camera, Recorded Videos, and About Us.
    """
    win.destroy()  # Destroying the previous window
    # Resetting global variables
    global show_result, burnt, reps, hours, minutes, seconds, flag_3, good
    reps = 0
    hours = 0
    minutes = 0
    seconds = 0
    ...
    # Creating the canvas and adding the image
    im = PhotoImage(file="pose body.png")
    can1 = Canvas(root, width=1000, height=750)
    can1.place(x=0, y=0)
    ...
    # Creating and placing the Live Button
    ...
    # Creating and placing the Video Button
    vid_photo = PhotoImage(file="vid.png")
    vid_btn = Button(root, image=vid_photo, width=130, height=100, borderwidth=0, relief="groove", command=videoBtn)
    can1.create_window(280, 15, anchor="nw", window=vid_btn)

    # Creating and placing the Set Goal Button
...
def setGoal():
    ...
    # Widgets
    ima = PhotoImage(file="tragetbackgroud.png") # Background Image

    can3 = Canvas(goal, width=1000, height=666) # Creating a Canvas for the window
    can3.place(x=0, y=0)
    can3.create_image(0, 0, image=ima, anchor="nw")

    # Taking Name of user
    name = Entry(goal, width=30,font="bold", bg="black", fg="snow", relief='groove')

    can3.create_text(80, 50, text="Name:", font=("Times", 20, "italic", "underline"), fill="white")
    ...
    duration = Entry(goal, width=30, font="bold", bg="black", fg="snow", relief='groove')

    can3.create_text(80, 130, text="Duration:", font=("Times", 20, "italic", "underline"), fill="white")
    ...
    # Taking Weight
    weight = Entry(goal, width=30,font="bold", bg="black", fg="snow", relief='groove')

    can3.create_text(80, 200, text="Weight:", font=("Times", 20, "italic", "underline"), fill="white")
    ...
    # Asking for reps
    repitions = Entry(goal, width=30,font="bold", bg="black", fg="snow", relief='groove')
    
    can3.create_text(80, 270, text="Reps:", font=("Times", 20, "italic", "underline"), fill="white")
    ...
    # Asking for Sets
    sets = Entry(goal, width=30,font="bold", bg="black", fg="snow", relief='groove')

    can3.create_text(80, 350, text="Sets:", font=("Times", 20, "italic", "underline"), fill="white")
    ...
    # Clear Button
    clr = Button(goal, text="CLEAR ALL", relief="groove", bg="black", fg="white", font = "Times 14 bold", borderwidth=7, command=clear)
    clr.place(x=50, y=400, width=130, height=60)
 # Done Button
    done_goal = Button(goal, text="DONE", relief="groove", bg="black", fg="white", font = "Times 14 bold", borderwidth=7, command=done)
    done_goal.place(x=350, y=400, width=90, height=60)
...
def videoBtn():
    ...
    bro = Label(video, text = 'Browse Video', bg="black", fg = "white", font = "Times 20 bold")
    bro.place(x = 390, y = 545, width=180, height=60)

    back_btn = Button(video, text = '< Back', bg = "white", fg = "black", font = "Times 14 bold", relief = "groove", borderwidth = 5, command=back_video)
...
def browse():
    ...
    video.filename = filedialog.askopenfilename(initialdir="/Users/alisa/Desktop/CP2_Semester_Project",
...
def play_video():
    ...
    back_btn = Button(video, text = '< Back', bg = "white", fg = "Black", font = "Times 14 bold", relief = "groove", borderwidth = 5, command=back_browse)
    back_btn.place(x = 50, y = 30, width=100, height=30)
...
def select_img():
    ...
    rep = Label(video, text = f'Reps:\n{int(reps):02}', bg="black", fg = "white", font = "Times 20 bold")
    rep.place(x = 100, y = 140, width=160, height=70)

    pos = Label(video, text = 'Posture:', bg="black", fg = "white", font = "Times 20 bold")
    pos.place(x = 100, y = 250, width=160, height=35) 

    lab = Label(video, text = f'{label}', bg="black", fg = "white", font = "Times 20 bold")
    ...
    per = Label(video, text=f'{int(right_shoulder_per_1)}%', bg="black", fg = "white", font = "Times 20 bold")
...
def live_stream():
    ...
    pos = Label(live, text = 'Posture:', bg = "black", fg = "white", font = "Times 20 bold")
    pos.place(x = 800, y = 150, width=160, height=35) 

    lab = Label(live, text = f'{label}', bg = "black", fg = "white", font = "Times 20 bold")
    ...
    per = Label(live, text=f'{int(right_shoulder_per_2)}%',bg = "black", fg = "white", font = "Times 20 bold")
...
def live_bt():
    ...
    start_btn = Button(live, text = 'START', bg = "black", fg = "white", font = "Times 14 bold", relief = "groove", borderwidth = 14, command=start)
    start_btn.place(x = 400, y = 520, width=160, height=55) 




    back_btn = Button(live, text = '< BACK', bg = "black", fg = "white", font = "Times 14 bold", relief = "groove", borderwidth = 5, command=back)
    back_btn.place(x = 30, y = 20, width=100, height=30)

    music_btn_img = PhotoImage(file="music.png")
...
def gif():
    ...
    ##img = Image.open("Dumbbell_Shoulder_Press.gif")##
    w8 = Label(root)
...
def timer():
    ...
    w9 = Label(live, text = 'Time:', bg = "black", fg = "white", font = "Times 25 bold")
    w9.place(x = 790, y = 40, width=170, height=25)

    if flag_3 == 0:

        clock = Label(live, text='00:00:00', height=2, bg='black', fg='white', font='Times 20')
    ...
    if sg == 1:
        ...
        shw_g = Label(live, text = f'Sets:  {se}/{temp_sets}', bg = "black", fg = "white", font = "Times 20 bold")
...
def start():
    ...
    reset_btn = Button(live, text = 'RESET', bg = "black", fg = "white", font = "Times 14 bold", relief = "groove", borderwidth = 14, command=reset)
    reset_btn.place(x = 210, y = 520, width=160, height=55)


    if show_result == 1:

        results_btn = Button(live, text = 'SHOW\nRESULTS', bg = "black", fg = "white", font = "Times 14 bold", relief = "groove", borderwidth = 10, command=results)
...
def results():
    ...
    bg_img = PhotoImage(file="final_result.png")

    can4 = Canvas(result, width=1000, height=666)
    can4.place(x=0, y=0)
    ...
    if good == 1:
        ...
        achieved = Label(result, text = 'Target Achieved', bg = "black", fg = "white", font = "Times 20 bold italic underline")
        achieved.place(x = 340, y = 50, width=250, height=27)

        well_done = Label(result, text = f' Well Done Mr. {temp_name}', bg = "black", fg = "red", font = "Times 18 bold")
        well_done.place(x = 330, y = 150, width=300, height=30)

    elif good == 0:

        achieved = Label(result, text = 'Target not Achieved', bg = "black", fg = "white", font = "Times 18 bold italic underline")
        achieved.place(x = 340, y = 50, width=280, height=30)

        well_done = Label(result, text = f' Try Again Mr. {temp_name}\nYou can do it', bg = "black", fg = "white", font = "Times 18 bold")
        well_done.place(x = 320, y = 150, width=280, height=30)


    w10 = Label(result, text = 'Workout Duration:', bg = "black", fg = "white", font = "Times 25 bold italic underline")
    w10.place(x = 50, y = 250, width=260, height=35) 

    w11 = Label(result, text = f'{hours_2-hours:02}:{minutes_2-minutes:02}:{(seconds_2-seconds)-1:02}', bg = "black", fg = "white", font = "Times 20 bold")
    w11.place(x = 340, y = 260, width=130, height=25)

    w14 = Label(result, text = 'Total Reps:', bg = "black", fg = "white", font = "Times 25 bold italic underline")
    w14.place(x = 40, y = 320, width=230, height=35) 

    w15 = Label(result, text = f'{int(se*count_repititions+reps):02}', bg = "black", fg = "white", font = "Times 20 bold")
    w15.place(x = 300, y = 330, width=50, height=25)

    cal = Label(result, text = 'Calories Burnt:', bg = "black", fg = "white", font = "Times 25 bold italic underline")
    cal.place(x = 50, y = 420, width=230, height=35) 

    burn = Label(result, text = f'{burnt_calories:2} Kcal', bg = "black", fg = "white", font = "Times 20 bold")
    burn.place(x = 350, y = 430, width=140, height=25)

    back_btn = Button(result, text = '<< Main Menu', bg = "black", fg = "white", font = "Times 14 bold", relief = "groove", borderwidth = 8, command=main_menu)
...
def play_music():
    ...
    live.filename = filedialog.askopenfilename(initialdir="/Users/alisa/Desktop/CP2_Semester_Project",
    ...
    stop_music = Button(live, text = 'STOP\nMUSIC', bg = "black", fg = "white", font = "Times 14 bold", relief = "groove", borderwidth = 7, command=stop_song)
...
pre_im = PhotoImage(file="first_window_page.png")

can = Canvas(win, width=1000, height=617)
can.place(x=0, y=0)
...
can.create_text(450, 90, text="\"VIRTUAL AI FITNESS TRAINER\"", font="Times 22 bold", fill="white")



pro_bt = PhotoImage(file="StART .png")

pro_bt_lab = Label(image=pro_bt)
proceed_btn = Button(win, image=pro_bt, borderwidth = 0, width=120, height=120, relief="groove", command = proceed)
can.create_window(395, 460, anchor="nw", window=proceed_btn)
